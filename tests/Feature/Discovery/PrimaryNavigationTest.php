...
class PrimaryNavigationTest extends TestCase
{
    ...
    public function test_seeded_mega_menu_renders_resolved_urls_accessibility_hooks_and_minimal_footer(): void
    {
        ...
        $this->assertStringContainsString('Gift Types', $header);
        ...
        $this->assertStringContainsString('Gifts for Colleagues', $header);
        $this->assertStringContainsString('Personalized Gifts', $header);
        $this->assertStringContainsString('Holi Gifts', $header);
        $this->assertStringContainsString('href="'.DiscoveryUrl::occasion('valentines-day').'"', $header);
        $this->assertStringContainsString('href="'.DiscoveryUrl::giftType('personalized-gifts').'"', $header);
        $this->assertStringContainsString('href="'.DiscoveryUrl::occasion('holi').'"', $header);
        $this->assertStringNotContainsString('Festival Gifts', $header);
        $this->assertStringNotContainsString('Online Courses', $header);
        $this->assertStringNotContainsString('E-books &amp; Audiobooks', $header);
        $this->assertStringNotContainsString('Eco-friendly gifts', $header);
        $this->assertStringNotContainsString('href="'.DiscoveryUrl::occasion('festival').'"', $header);
        $this->assertStringNotContainsString('href="'.DiscoveryUrl::giftType('online-courses').'"', $header);
        $this->assertStringNotContainsString('href="'.DiscoveryUrl::giftType('ebooks-audiobooks').'"', $header);
        $this->assertStringNotContainsString('href="'.DiscoveryUrl::giftIdeasCategory('personalized-gifts').'"', $header);
