...
- Friends is a real recipient Relationship, not a catch-all for "anyone could receive this". Assign Friends only when the product has meaningful friend-gifting affinity compared with the general population. Legitimate Friends examples include friendship photo keepsakes, generic personalized caricatures or standees that are not dedicated to a romantic or family recipient, best-friend products, friendship lamps, friendship bracelets, memory or farewell gifts, and friend-oriented photo albums. Do not assign Friends merely because a friend could technically receive a generic product such as a keyboard, sunglasses, tyre inflator, generic speaker, grooming kit, or generic wallet. Do not add Friends to every personalized product. Explicit romantic or family recipient evidence still governs: a Husband- or Boyfriend-specific caricature should not automatically receive Friends merely because it is a caricature.
